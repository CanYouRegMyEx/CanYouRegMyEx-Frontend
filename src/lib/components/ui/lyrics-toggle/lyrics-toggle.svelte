...
<div class="text-center mb-8">
	...
	<div class="inline-flex items-center justify-center space-x-4">
		<Languages class="w-5 h-5 text-purple-600" />
		<div class="relative group">
			<!-- Toggle Button -->
			<button 
				onclick={handleToggle}
				class="relative inline-flex items-center w-20 h-10 bg-gray-200 rounded-full border-2 border-gray-300 focus:outline-none focus:ring-4 focus:ring-purple-300 transition-colors duration-300 hover:bg-gray-300"
		...
		<Volume2 class="w-5 h-5 text-purple-600" />
	</div>
</div>
